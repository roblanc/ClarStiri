    ...
    <Link to={`/stire/${news.id}`} className="block h-full group">
      <article className="bg-card border border-border flex flex-col h-full group-hover:bg-secondary/20 transition-colors">
        ...
        <div className="p-4 md:p-5 flex-1 flex flex-col relative z-10">
          ...
          <div className="mt-auto pt-2 md:pt-4 flex flex-col gap-2 md:gap-3 bg-[#D4A017] -mx-4 md:-mx-5 -mb-4 md:-mb-5 px-4 md:px-5 py-3 md:py-4">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-1 text-[10px] font-bold uppercase tracking-wider text-black/70">
              <span className="text-black">{news.category || "ACTUALITATE"}</span>
              <span>•</span>
