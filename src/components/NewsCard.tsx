  ...
  if (variant === 'poster') {
    return (
      <Link to={buildStoryHref(news.id, news.title)} className="block h-full group">
        <article className="group flex h-full flex-col gap-3 transition-transform duration-300 hover:-translate-y-1">
          <div className="relative aspect-[16/10] overflow-hidden rounded-[2px] border border-zinc-900/80 bg-[#111111] shadow-[0_18px_34px_-24px_rgba(0,0,0,0.34)]">
            <NewsImage
            ...
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.02)_0%,rgba(0,0,0,0.14)_32%,rgba(0,0,0,0.26)_64%,rgba(0,0,0,0.36)_100%)]" />
          ...
          <div className="border border-border/70 bg-card px-4 py-4 shadow-[0_10px_28px_-20px_rgba(0,0,0,0.28)]">
            <div className="mb-3 flex flex-wrap items-center gap-2 text-[10px] font-bold uppercase tracking-[0.26em] text-muted-foreground">
            ...
            <h3 className="font-title text-[1.55rem] font-bold leading-[1.06] tracking-[-0.04em] text-foreground sm:text-[1.75rem]">
              {news.title}
            </h3>
          </div>
