...
const SOURCE_CATALOG_BASE: SourceCatalogEntry[] = [
  ...
  { id: 'realitatea', name: 'Realitatea TV', url: 'https://www.realitatea.net', rssUrl: 'https://www.realitatea.net/feed/', bias: 'right', factuality: 'mixed', category: 'mainstream' },
];
