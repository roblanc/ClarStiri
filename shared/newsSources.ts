...
export const NEWS_SOURCES_BASE = [
  ...
  { id: 'realitatea', name: 'Realitatea Plus', url: 'https://www.realitatea.net', rssUrl: 'http://rss.realitatea.net/homepage.xml', bias: 'right', factuality: 'mixed', category: 'mainstream' },
